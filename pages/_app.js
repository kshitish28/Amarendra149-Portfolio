...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Amarendra Nayak";
	const description =
		"Hello! I'm Amarendra Nayak, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
	...
	const url = "https://amarendranayak-myportfolio.vercel.app/";
	...
	return (
		<>
			<Head>
				...
				<meta name="twitter:creator" content="@amarendranayak" />
